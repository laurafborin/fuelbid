  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <MetricCard label="Leiloes Abertos" value={leiloes.length} icon="🔥" />
        <MetricCard label="Meus Lances" value={lanceCount} icon="🎯" />
        <MetricCard label="Taxa de Conversao" value="--%" icon="📈" />
        <MetricCard label="Receita Est." value="R$ --" icon="💰" />
      </div>

      <h2 className="text-lg font-semibold text-gray-900 mb-4">Leiloes Abertos</h2>
      {loading ? (
